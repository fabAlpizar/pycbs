...
Welcome to `pyCBS` contributor's guide.
...
If you experience bugs or general issues with `pyCBS`, please have a look
...
You can help improve `pyCBS` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pyCBS` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pyCBS`'s files. While this mechanism can
...
```
conda create -n pyCBS python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pyCBS.git
   cd pyCBS
   ```
...
5. Install [pre-commit]:
   ...
   `pyCBS` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pyCBS
[issue tracker]: https://github.com/<USERNAME>/pyCBS/issues
